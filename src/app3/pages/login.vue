<template>
  <div class="loginBox">
          <img src='../../../static/images/loginBackground.png' alt="" style="
    width: 100%;
    height: 100%;
">
          <div class="col s12 z-depth-6 card-panel" style="position: absolute;top: 22%;right: 8%;width: 324px;height: 454px;">
            <form class="login-form" style="
                  padding-top: 50px;
              "  :model="form" :rules="rules" ref="form">
              <div class="row">
                <div class="input-field col s12 center">
                  <h6 class="center login-form-text" style="
                    font-weight: 600;
                ">欢迎登录</h6>
                </div>
              </div>
              <div class="row margin">
                <div class="input-field col s12">
                 <img class="imgpos " src="../../../static/images/user.png" alt="">
                  <input style="
                      padding-left: 36px;
              ...
              <div class="row margin">
                <div class="input-field col s12">
                  <img class="imgpos" src="../../../static/images/password.png" alt="" style="width:20;height:21px">
                  <input style="
                      padding-left: 36px;
                  " id="password"  type="password"  @keyup.13="handleLoginClick"   v-model="form.password" :minlength="6" :maxlength="6" prop="password">
                  <label for="password"></label>
                </div>
              </div>

              <div class="row">
                <div class="input-field col s12" @click="handleLoginClick">
...
//-     v-input(label="手机号" type="text" v-model="form.username" placeholder="请输入手机号" :maxlength="11" prop="username")
//-     v-input(label="密码" type="password" v-model="form.password" placeholder="请输入密码" :maxlength="6" prop="password")
...
import {errorMsg} from '../common/util.js'
export default {
  data() {
    return {
      form: {
  ...
  methods: {
      ...
      axios({
        ...
        if (res.data.status !=200) {
          ...
          if(res.data.data.UserDetail){
            const UserDetail = JSON.parse(res.data.data.UserDetail);
            setCookie("Token", res.data.data.access_token);
            setCookie("currentUserId", UserDetail.UserId);
            setCookie("currentRoleId", UserDetail.RoleId);
            setCookie("DepartmentId", UserDetail.DepartmentId);
    ...
    queryDepartment() {
      axios({
        ...
        params: {
          AccountId: getCookie("currentUserId"),
